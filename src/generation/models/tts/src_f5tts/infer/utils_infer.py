...
def load_model(
    ...
    if vocab_file == "":
        # Default vocab file path - should be provided by caller
        vocab_file = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "configs", "vocab.txt")
    tokenizer = "custom"
