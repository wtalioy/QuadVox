...
class Frontend_S(nn.Module):
    ...
    def __init__(self, sinc_kernel_size=128, sample_rate=16000):
        ...
        N: number of conv2D-based blocks. N is fixed to 4.
        C: output channel of front-end. C is fixed to 64
        f: frequency. f is fixed to 23
        t: number of temporal bins. for 4 sec, t is 16. for 10 sec, t is 73
        """
...
class Frontend_L(nn.Module):
    ...
    def __init__(self, sinc_kernel_size=128, sample_rate=16000):
        """_summary_
        frontend of Rawformer-L. N fixed to 6, C=64, f=23. for 4 sec t=29.
        """
...
class Frontend_SE(nn.Module):
    ...
    def __init__(self, sinc_kernel_size=128, sample_rate=16000):
        """_summary_
        frontend of SE-Rawformer. N=4, C=64, f=23. for 4 sec t=16.
        """
